...
saveBlobToFile = function(blobUrl, resultsLabel) {
  output_file = "/Users/ameykelekar/Downloads/myresults4.csv" # Replace this with the location you would like to use for your output file
...
invokeBatchExecutionService = function() {
  ...
  api_key = "pjcITAvGZ6c6hmM1/bTgQ3ib4DIHrLhNRaCEQSkxFAIA/22KhDLpxKldz05GC0hEyul2PsFI/LRG1ImEZ6yTVg==" # Replace this with the API key for the web service
  url = "https://ussouthcentral.services.azureml.net/workspaces/0462d59e8f4343459d564ac7b2dea119/services/5a873c07635b4597821bc9d815267634/jobs"
  ...
  payload =  list(
    ...
    Outputs=list(
      output1=list(ConnectionString=connection_string, RelativeLocation=paste("/", storage_container_name, "/outputresults4.csv", sep=''))
    ),
