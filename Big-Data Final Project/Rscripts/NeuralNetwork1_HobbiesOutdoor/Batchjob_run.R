...
saveBlobToFile = function(blobUrl, resultsLabel) {
  output_file = "/Users/ameykelekar/Downloads/myresults13.csv" # Replace this with the location you would like to use for your output file
...
invokeBatchExecutionService = function() {
  ...
  api_key = "IZ/DIaZuk2sV6k6aqQg2EozIq38fqqGFRw1ZHFP/Oi4wMWz43Xx8xXPtCfY1uO5iXsYse0m0d3XBMLufOLktHw==" # Replace this with the API key for the web service
  url = "https://ussouthcentral.services.azureml.net/workspaces/0462d59e8f4343459d564ac7b2dea119/services/8fb032cba26d4c158235c64e03122efa/jobs"
