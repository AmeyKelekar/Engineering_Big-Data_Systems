...
saveBlobToFile = function(blobUrl, resultsLabel) {
  output_file = "/Users/ameykelekar/Downloads/myresults10.csv" # Replace this with the location you would like to use for your output file
...
invokeBatchExecutionService = function() {
  ...
  storage_account_name = "vasanti1" # Replace this with your Azure Storage Account name
  storage_account_key = "soY1ExmZcqvncVaqPIZ33BvC26ngEm9v7B60PcgUZQWGJi8yFvJ3dVflW09y4HKxx02arcEpcI0UcN8RD3j54g==" # Replace this with your Azure Storage Key
  ...
  api_key = "ZQ7BnlFi+9GdctXPte7y95b4jM97idoCn4OS8LV60b0ENBKyPQls8xqVq9optp+XXruKA1bz5OcQ5BNFT31SkQ==" # Replace this with the API key for the web service
  url = "https://ussouthcentral.services.azureml.net/workspaces/0462d59e8f4343459d564ac7b2dea119/services/d4928bf4182747bca3f2f73aeba1cc22/jobs"
  
  authz_hdr = paste("Bearer", api_key, sep=" ")
  payload =  list(
    Inputs=list(
      input1=list(ConnectionString=connection_string, RelativeLocation=paste("/", storage_container_name, "/Listings_User_Merged_test.csv", sep=''))    
    ),
    Outputs=list(
      output1=list(ConnectionString=connection_string, RelativeLocation=paste("/", storage_container_name, "/outputresults10.csv", sep=''))
    ),
