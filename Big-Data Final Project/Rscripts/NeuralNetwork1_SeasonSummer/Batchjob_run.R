...
saveBlobToFile = function(blobUrl, resultsLabel) {
  output_file = "/Users/ameykelekar/Downloads/myresults6.csv" # Replace this with the location you would like to use for your output file
...
invokeBatchExecutionService = function() {
  ...
  api_key = "2hkhIN6xGm/q6sR4225B057VnlVMUaTWoxX4s7f9w1eO1Iszz4SyFQcXtaa6XNXZVJfcCpxYXueuhxcLiMu7Ug==" # Replace this with the API key for the web service
  url = "https://ussouthcentral.services.azureml.net/workspaces/0462d59e8f4343459d564ac7b2dea119/services/855939f7f9314537a21ad43c0794a17b/jobs"
