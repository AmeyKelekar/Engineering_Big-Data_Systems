...
saveBlobToFile = function(blobUrl, resultsLabel) {
  output_file = "/Users/ameykelekar/Downloads/myresults8.csv" # Replace this with the location you would like to use for your output file
...
invokeBatchExecutionService = function() {
  ...
  api_key = "tcbrPO2jOwMIsA2n0zv8LfseykxETR76wIgxouqq9J24+EhRMvcXHlbFm8rtW2vXn7i/aH4JrjyH0jNJm/C4ZQ==" # Replace this with the API key for the web service
  url = "https://ussouthcentral.services.azureml.net/workspaces/0462d59e8f4343459d564ac7b2dea119/services/207cf354eebe4c509ebcde966f154d03/jobs"
  ...
  payload =  list(
    ...
    Outputs=list(
      output1=list(ConnectionString=connection_string, RelativeLocation=paste("/", storage_container_name, "/outputresults8.csv", sep=''))
    ),
