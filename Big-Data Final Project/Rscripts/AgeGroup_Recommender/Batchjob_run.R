...
invokeBatchExecutionService = function() {
  ...
  api_key = "al8v1+iWwexINkHXygXI8JIzLbCo9VC768tZAkQ8UEUdXg95QoucihiraZFK84+nvrkUZTZG6O/w756FzW5Sew==" # Replace this with the API key for the web service
  url = "https://ussouthcentral.services.azureml.net/workspaces/0462d59e8f4343459d564ac7b2dea119/services/f5a98124d1d242808e2f89d12d1d834e/jobs"
  ...
  payload =  list(
    ...
    Outputs=list(
      output1=list(ConnectionString=connection_string, RelativeLocation=paste("/", storage_container_name, "/results.csv", sep=''))
    ),
