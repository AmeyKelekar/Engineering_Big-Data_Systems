...
saveBlobToFile = function(blobUrl, resultsLabel) {
  output_file = "/Users/ameykelekar/Downloads/results.csv" # Replace this with the location you would like to use for your output file
...
invokeBatchExecutionService = function() {
  ...
  api_key = "mIFn6eB3jktbZrem4ky+cHylcN/KJ2gg4+/wqHTIRwA/YqZiljuPlRYDsm92d8HaBtzfmKOvYskiJ3lqAGeaAg==" # Replace this with the API key for the web service
  url = "https://ussouthcentral.services.azureml.net/workspaces/0462d59e8f4343459d564ac7b2dea119/services/9ccbd5856e3148c39e3c0295da6aebbf/jobs"
  
  authz_hdr = paste("Bearer", api_key, sep=" ")
  payload =  list(
    Inputs=list(
      input1=list(ConnectionString=connection_string, RelativeLocation=paste("/", storage_container_name, "/Users.csv", sep=''))    
    ),
    Outputs=list(
      output1=list(ConnectionString=connection_string, RelativeLocation=paste("/", storage_container_name, "/results1.csv", sep=''))
    ),
